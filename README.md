...
- Install [python 3.8.2](https://www.python.org/downloads/release/python-382/) using the official installation file
- Install all project dependencies with `pip install -r requirements.txt`
...
- Run the command: `python -m pytest -v --gherkin-terminal-reporter --reruns 1 --reruns-delay 1 --tags="automated" -s --color="yes"`
...
```
============================= test session starts ==============================
platform darwin -- Python 3.8.2, pytest-5.4.2, py-1.11.0, pluggy-0.13.1 -- /Volumes/Volume_1/Personal/PycharmProjects/bdd-gherkin-api-test-automation-framework/tests/.venv/bin/python
cachedir: .pytest_cache
rootdir: /Volumes/Volume_1/Personal/PycharmProjects/bdd-gherkin-api-test-automation-framework/tests, inifile: pytest.ini
plugins: rerunfailures-9.0, bdd-4.0.2
collecting ... collected 6 items

step_definitions/test_sample.py::test_post_example[post_payload_1.json] <- .venv/lib/python3.8/site-packages/pytest_bdd/scenario.py 
step_definitions/test_sample.py::test_post_example[post_payload_2.json] <- .venv/lib/python3.8/site-packages/pytest_bdd/scenario.py 
step_definitions/test_sample.py::test_get_example <- .venv/lib/python3.8/site-packages/pytest_bdd/scenario.py 
step_definitions/test_sample.py::test_update_example[put_payload_1.json] <- .venv/lib/python3.8/site-packages/pytest_bdd/scenario.py 
step_definitions/test_sample.py::test_update_example[put_payload_2.json] <- .venv/lib/python3.8/site-packages/pytest_bdd/scenario.py 
step_definitions/test_sample.py::test_delete_example <- .venv/lib/python3.8/site-packages/pytest_bdd/scenario.py 
================================ Report Summary ================================
Total Test Duration: 3.11 seconds
...
Response Header Fields: {'Date': 'Sun, 30 Oct 2022 06:36:43 GMT', 'Content-Type': 'application/json; charset=utf-8', 'Content-Length': '65', 'Connection': 'keep-alive', 'X-Powered-By': 'Express', 'X-Ratelimit-Limit': '1000', 'X-Ratelimit-Remaining': '999', 'X-Ratelimit-Reset': '1667111851', 'Vary': 'Origin, X-HTTP-Method-Override, Accept-Encoding', 'Access-Control-Allow-Credentials': 'true', 'Cache-Control': 'no-cache', 'Pragma': 'no-cache', 'Expires': '-1', 'Access-Control-Expose-Headers': 'Location', 'Location': 'http://jsonplaceholder.typicode.com/posts/101', 'X-Content-Type-Options': 'nosniff', 'Etag': 'W/"41-GDNaWfnVU6RZhpLbye0veBaqcHA"', 'Via': '1.1 vegur', 'CF-Cache-Status': 'DYNAMIC', 'Server-Timing': 'cf-q-config;dur=5.9999983932357e-06', 'Report-To': '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=KiP6E5pJic2OKyMOp97CS9X%2BtpD6AUUK0OTt9Hk7eNRHz0rIJYMS3QtDdDcUkDd0Box1hUUpVP0HbgP1nAHhYLt%2FcNJM9ciVMyWSprV0jrly0q6IoYw%2B8yDZSOVu2aBts5wGKP2uYXwnKmp3bCQH"}],"group":"cf-nel","max_age":604800}', 'NEL': '{"success_fraction":0,"report_to":"cf-nel","max_age":604800}', 'Server': 'cloudflare', 'CF-RAY': '762223609e8eab53-SIN', 'alt-svc': 'h3=":443"; ma=86400, h3-29=":443"; ma=86400'} 
...
Request URI: http://jsonplaceholder.typicode.com/posts 
Request Header: {'Content-type': 'application/json; charset=UTF-8'} 
Request Body: {'title': 'bar', 'body': 'foo', 'userId': 2} 
Response Status Code: 201 
Response Header Fields: {'Date': 'Sun, 30 Oct 2022 06:36:44 GMT', 'Content-Type': 'application/json; charset=utf-8', 'Content-Length': '65', 'Connection': 'keep-alive', 'X-Powered-By': 'Express', 'X-Ratelimit-Limit': '1000', 'X-Ratelimit-Remaining': '998', 'X-Ratelimit-Reset': '1667111851', 'Vary': 'Origin, X-HTTP-Method-Override, Accept-Encoding', 'Access-Control-Allow-Credentials': 'true', 'Cache-Control': 'no-cache', 'Pragma': 'no-cache', 'Expires': '-1', 'Access-Control-Expose-Headers': 'Location', 'Location': 'http://jsonplaceholder.typicode.com/posts/101', 'X-Content-Type-Options': 'nosniff', 'Etag': 'W/"41-Bu4ZepEc4CMv77q8gsiyReMdimE"', 'Via': '1.1 vegur', 'CF-Cache-Status': 'DYNAMIC', 'Server-Timing': 'cf-q-config;dur=6.0000020312145e-06', 'Report-To': '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=gol3lQdUHa0tf0oC%2BKo%2FrNi5UGAWHnR5xg%2FLhQ3TVbko5Qx6sbSkRcZEjO7ZWWBRbQsnU%2F2Jcdvrh5y61BXBHciyTkKYaEhsFcAv36ePrcYhsGbR6iTgQazsu%2BJ8zRgLew0bTF4A6Y3LS%2Bd8fLHR"}],"group":"cf-nel","max_age":604800}', 'NEL': '{"success_fraction":0,"report_to":"cf-nel","max_age":604800}', 'Server': 'cloudflare', 'CF-RAY': '762223662bcd71fe-LHR', 'alt-svc': 'h3=":443"; ma=86400, h3-29=":443"; ma=86400'} 
Response Body: {'title': 'bar', 'body': 'foo', 'userId': 2, 'id': 101} 
...
Response Header Fields: {'Date': 'Sun, 30 Oct 2022 06:36:44 GMT', 'Content-Type': 'application/json; charset=utf-8', 'Transfer-Encoding': 'chunked', 'Connection': 'keep-alive', 'X-Powered-By': 'Express', 'X-Ratelimit-Limit': '1000', 'X-Ratelimit-Remaining': '999', 'X-Ratelimit-Reset': '1666195401', 'Vary': 'Origin, Accept-Encoding', 'Access-Control-Allow-Credentials': 'true', 'Cache-Control': 'max-age=43200', 'Pragma': 'no-cache', 'Expires': '-1', 'X-Content-Type-Options': 'nosniff', 'Etag': 'W/"6b80-Ybsq/K6GwwqrYkAsFxqDXGC7DoM"', 'Content-Encoding': 'gzip', 'Via': '1.1 vegur', 'CF-Cache-Status': 'HIT', 'Age': '16614', 'Server-Timing': 'cf-q-config;dur=6.9999950937927e-06', 'Report-To': '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=rwjCE6HftEWGE9cVpuqEBZifk9eeWxMZU02VE8a3qpv6F2V01I9nCiv1yKV%2FbAEM1icuhKwrhSCpXw7R9KSeSIJqzZXLjHkEKipwmR68Gm1qoFKuZlQwvSjkDkV2cIkuIUsGwjlk0ZZ%2BWd5RT3lK"}],"group":"cf-nel","max_age":604800}', 'NEL': '{"success_fraction":0,"report_to":"cf-nel","max_age":604800}', 'Server': 'cloudflare', 'CF-RAY': '762223692d2172e2-LHR', 'alt-svc': 'h3=":443"; ma=86400, h3-29=":443"; ma=86400'} 
...
Request Method: PUT 
Request URI: http://jsonplaceholder.typicode.com/posts/1 
Request Header: {'Content-type': 'application/json; charset=UTF-8'} 
Request Body: {'id': 1, 'title': 'abc', 'body': 'xyz', 'userId': 1} 
Response Status Code: 200 
Response Header Fields: {'Date': 'Sun, 30 Oct 2022 06:36:44 GMT', 'Content-Type': 'application/json; charset=utf-8', 'Transfer-Encoding': 'chunked', 'Connection': 'keep-alive', 'X-Powered-By': 'Express', 'X-Ratelimit-Limit': '1000', 'X-Ratelimit-Remaining': '997', 'X-Ratelimit-Reset': '1667111851', 'Vary': 'Origin, Accept-Encoding', 'Access-Control-Allow-Credentials': 'true', 'Cache-Control': 'no-cache', 'Pragma': 'no-cache', 'Expires': '-1', 'X-Content-Type-Options': 'nosniff', 'Etag': 'W/"3f-/E4tLhCKcICzHZZWDfwwQTy/Slc"', 'Via': '1.1 vegur', 'CF-Cache-Status': 'DYNAMIC', 'Server-Timing': 'cf-q-config;dur=4.000001354143e-06', 'Report-To': '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=6ly0360nDhQdCXDZJepX7AfLkMer%2FbAznRzOvEhtw5maNDiiQSvhKy1QwiK0f7RVWGq8skZfUXhtv02EFkZFzL3Yf1aZg6j356aOAhu1ZtkaF7mseFcBDIUep5gZe448ic8PPpen0iGYitPebGB3"}],"group":"cf-nel","max_age":604800}', 'NEL': '{"success_fraction":0,"report_to":"cf-nel","max_age":604800}', 'Server': 'cloudflare', 'CF-RAY': '7622236b29347332-LHR', 'Content-Encoding': 'gzip', 'alt-svc': 'h3=":443"; ma=86400, h3-29=":443"; ma=86400'} 
Response Body: {'id': 1, 'title': 'abc', 'body': 'xyz', 'userId': 1} 
...
Request URI: http://jsonplaceholder.typicode.com/posts/1 
Request Header: {'Content-type': 'application/json; charset=UTF-8'} 
Request Body: {'id': 1, 'title': 'testing', 'body': 'testing', 'userId': 1} 
Response Status Code: 200 
Response Header Fields: {'Date': 'Sun, 30 Oct 2022 06:36:45 GMT', 'Content-Type': 'application/json; charset=utf-8', 'Transfer-Encoding': 'chunked', 'Connection': 'keep-alive', 'X-Powered-By': 'Express', 'X-Ratelimit-Limit': '1000', 'X-Ratelimit-Remaining': '996', 'X-Ratelimit-Reset': '1667111851', 'Vary': 'Origin, Accept-Encoding', 'Access-Control-Allow-Credentials': 'true', 'Cache-Control': 'no-cache', 'Pragma': 'no-cache', 'Expires': '-1', 'X-Content-Type-Options': 'nosniff', 'Etag': 'W/"47-UzR4jYNDwb6R2jnqncsLRxStjvQ"', 'Via': '1.1 vegur', 'CF-Cache-Status': 'DYNAMIC', 'Server-Timing': 'cf-q-config;dur=6.0000020312145e-06', 'Report-To': '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=V7iV6LkrBMyVWeuGWLaL8Qsm3Z87BGM278R%2BU9VL1rHdZDXRDH2jDkTDAzghZMHSBeEOUpcev3IqyL4%2Ba1Yu1bVY6UPZPbgwi9f5%2F1MIOO%2FTi4HAGVu0%2FOaU2xNIzZeXjZ2oeOZerdAA9PL2VZyD"}],"group":"cf-nel","max_age":604800}', 'NEL': '{"success_fraction":0,"report_to":"cf-nel","max_age":604800}', 'Server': 'cloudflare', 'CF-RAY': '7622236e1a13759d-LHR', 'Content-Encoding': 'gzip', 'alt-svc': 'h3=":443"; ma=86400, h3-29=":443"; ma=86400'} 
Response Body: {'id': 1, 'title': 'testing', 'body': 'testing', 'userId': 1} 
...
Request Header: {'Content-type': 'application/json; charset=UTF-8'} 
Response Status Code: 200 
Response Header Fields: {'Date': 'Sun, 30 Oct 2022 06:36:45 GMT', 'Content-Type': 'application/json; charset=utf-8', 'Content-Length': '2', 'Connection': 'keep-alive', 'X-Powered-By': 'Express', 'X-Ratelimit-Limit': '1000', 'X-Ratelimit-Remaining': '995', 'X-Ratelimit-Reset': '1667111851', 'Vary': 'Origin, Accept-Encoding', 'Access-Control-Allow-Credentials': 'true', 'Cache-Control': 'no-cache', 'Pragma': 'no-cache', 'Expires': '-1', 'X-Content-Type-Options': 'nosniff', 'Etag': 'W/"2-vyGp6PvFo4RvsFtPoIWeCReyIC8"', 'Via': '1.1 vegur', 'CF-Cache-Status': 'DYNAMIC', 'Server-Timing': 'cf-q-config;dur=7.0000023697503e-06', 'Report-To': '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=VdKG%2FcSpOnz4t1gX8TPiyFh3Q%2B8o42%2FUkyJRvKu1GDEFsvCRgOJe3HuZZPzAmV2VKN3VsZ0JjZBeJLPuvMp1Wt65tvcSPElylkMmtOVaryaEuxVnl824EjprY1QVdWHcqJN%2FN3AuYk1S3MeyXUOH"}],"group":"cf-nel","max_age":604800}', 'NEL': '{"success_fraction":0,"report_to":"cf-nel","max_age":604800}', 'Server': 'cloudflare', 'CF-RAY': '76222371093de624-LHR', 'alt-svc': 'h3=":443"; ma=86400, h3-29=":443"; ma=86400'} 
Response Body: {} 
