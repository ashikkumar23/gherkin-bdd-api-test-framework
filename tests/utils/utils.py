...
def post_request(payload, headers):
    ...
    response = requests.post(url=f'{post_url}', data=json.dumps(ast.literal_eval(payload)), headers=headers)
    print(
...
def put_request(payload, headers):
    ...
    response = requests.put(url=f'{put_url}', data=json.dumps(ast.literal_eval(payload)), headers=headers)
    print(
